...
static void mdlCheckParameters(SimStruct *S)
{
    ...
    /* TICK_RES */
    if (!mxIsDouble(TICK_RES) || mxIsComplex(TICK_RES) ||
        mxGetNumberOfElements(TICK_RES) != 1) {
    ...
    /* PRIORITY */
    if (!mxIsDouble(PRIORITY) || mxIsComplex(PRIORITY) ||
        mxGetNumberOfElements(PRIORITY) != 1) {
...
static void mdlRTW(SimStruct *S)
{
    ...
    {
        /* If write failed, still free any allocations below */
    }
